export const LABELS = {
  ...
  WALLET_APPROVE_PROMPT: "You are trying to make a purchase. Please approve the transaction in your wallet.",
  SUCCESSFUL_PURCHASE: "Congrats on the purchase. It was successful",
  FAILED_PURCHASE: "Uh Oh! Something went wrong. Our developers have been notified and we are on it.",
};
