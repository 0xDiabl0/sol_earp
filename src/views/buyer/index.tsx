  ...
  return (
    ...
    <Row>
      ...
      <Row gutter={[16, 16]} align="middle">
        ...
        <Listings price={0.05} destAddress="3hedy2UffFfEqG5mDi6TFKWpYFxdVveQkJyo6m27mVSM" />

        <Listings price={0.025} destAddress="JBhN4h6yT72AbeFVMt4BadGZTPvYQEaAuHC2k4XT2wfY" />

        <Listings price={0.15} destAddress="JBhN4h6yT72AbeFVMt4BadGZTPvYQEaAuHC2k4XT2wfY" />
